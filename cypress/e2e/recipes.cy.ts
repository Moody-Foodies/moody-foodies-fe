...
describe('Recipe carousel page', () => {
        ...
        cy.intercept('GET', 'https://brain-food-501b641e50fb.herokuapp.com/api/v1/recipes/favorites?user_id=1', {
            ...
            body: 
                {"data": {
                    ...
                    "recipes": [
                        {"id": "https://img.spoonacular.com/recipes/715415-312x231.jpg", 
                        "type": "recipe", 
                        "user_id": 1, 
                        "attributes": {
    ...
    "ingredients": [
        ...
        "2 cups dried red lentils, rinsed", "salt and black pepper, to taste", 
    ...
    it('Should show all the recipes based on mood level and time allotted to cook', () => {
        ...
        cy.get('.menu').first().contains('Mood Board').click()
    })
})